...
public interface DictServiceSoap {
    ...
    @RequestWrapper(localName = "ServerInfo", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.ServerInfo")
    @ResponseWrapper(localName = "ServerInfoResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.ServerInfoResponse")
     ...
     * 
     * @return
     *     returns lab1.ArrayOfDictionary
     */
    ...
    @RequestWrapper(localName = "DictionaryList", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DictionaryList")
    @ResponseWrapper(localName = "DictionaryListResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DictionaryListResponse")
    ...
    @RequestWrapper(localName = "DictionaryListExtended", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DictionaryListExtended")
    @ResponseWrapper(localName = "DictionaryListExtendedResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DictionaryListExtendedResponse")
    ...
    @RequestWrapper(localName = "DictionaryInfo", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DictionaryInfo")
    @ResponseWrapper(localName = "DictionaryInfoResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DictionaryInfoResponse")
    ...
    @RequestWrapper(localName = "Define", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.Define")
    @ResponseWrapper(localName = "DefineResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DefineResponse")
    ...
    @RequestWrapper(localName = "DefineInDict", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DefineInDict")
    @ResponseWrapper(localName = "DefineInDictResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.DefineInDictResponse")
    ...
    @RequestWrapper(localName = "StrategyList", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.StrategyList")
    @ResponseWrapper(localName = "StrategyListResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.StrategyListResponse")
     ...
     * @param word
     * @return
     *     returns lab1.ArrayOfDictionaryWord
     */
    ...
    @RequestWrapper(localName = "Match", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.Match")
    @ResponseWrapper(localName = "MatchResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.MatchResponse")
    ...
    @RequestWrapper(localName = "MatchInDict", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.MatchInDict")
    @ResponseWrapper(localName = "MatchInDictResponse", targetNamespace = "http://services.aonaware.com/webservices/", className = "lab1.MatchInDictResponse")
